  ...
  <div className="flex flex-wrap gap-2">
    {interests.map((interest) => (
      <button
        ...
        className={`px-4 py-2 rounded-full ${activeInterest === interest ? 'bg-blue-600 text-white' : 'bg-gray-300 text-gray-800'} hover:bg-blue-500 hover:text-white transition`}
      >
        {interest}
      </button>
    ))}
